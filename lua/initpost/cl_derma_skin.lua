--\\
hg.VGUI = hg.VGUI or {}
hg.VGUI.MainColor = Color(131, 131 ,131)
hg.VGUI.SecondaryColor = Color(141,141,141,240)
...
SKIN.Colours.Outline = Color(128, 128, 128)
...
function SKIN:PaintPropertySheet( panel, width, height )
	...
	surface.SetDrawColor(112, 112, 112, 150)
	surface.DrawOutlinedRect(0, 0, width, height)
end
...
function SKIN:PaintActiveTab( panel, w, h )
	...
	surface.SetDrawColor(156, 156, 156, 150)
